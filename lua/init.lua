...
vim.keymap.set('n', '<leader>sg', require('telescope.builtin').grep_string, { desc = '[S]earch current Word' })
vim.keymap.set('n', '<leader>sw', require('telescope.builtin').live_grep, { desc = 'Repo-wide Search' })
vim.keymap.set('n', '<leader>sa', ':Telescope ast_grep<CR>', { desc = '[S]earch by [A]ST Grep' })
